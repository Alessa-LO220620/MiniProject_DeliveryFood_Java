...
public class ProgramaMain {
	public static void main(String[] args) {
		...
		switch (escolhaDoTipoLanche) {
	     case 1:
	       	 System.out.println("                              Para o sanduíche você precisa escolher os ingredientes                         ");
	     ...
	     case 4:
	    	 System.out.println("                    Você escolheu Salgado. Digite qual o tipo você deseja");
	    	 System.out.println("___________________________________________________________________________________________________________ ");
	    	 escolherSalgado();
	    	 break;
	     default:
	...
	public static void escolherTipoDeMassa() {
			...
			switch (escolhaDoTipoMassa) {
	       		...
	       		case 2:
	       			...
	       			System.out.println(" Escolha a opções desejada:");
	       			System.out.println("  ");
	...
	public static void escolherSalgado(){
		...
		Scanner lerDados = new Scanner(System.in);
			...
			System.out.println("-----------------Opções de Salgado, escolha a sua preferência---------------------------------");
			System.out.println(" ");
			System.out.println("                                  [ 1 ] - Assado ...... R$ 5,00");
			System.out.println("                                  [ 2 ] - Frito ........... R$ 6,00");
			System.out.println(" Escolha a opções desejada:");
			System.out.println("  ");
		
		escolherSalgado = lerDados.nextInt();
		switch(escolherSalgado){
		case 1:
			salgado1.setTipoSalgado("Salgado Assado");
			salgado1.setPreco(5);
			break;
		
		case 2:
			salgado1.setTipoSalgado("Salgado Frito");
			salgado1.setPreco(6);
			break;
	...
	public static void mensagemTempoDeEntrega() {
		...
		System.out.println(" ");
		System.out.println("                Para o cálculo do tempo de entrega, precisamos saber a distância até sua casa! ");
		System.out.println(" ");
